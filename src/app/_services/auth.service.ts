...
export class AuthService {
  ...
  changepassword(Oldpassword:string,Newpassword:string): Observable<any> {
    ...
    return this.http.post(AUTH_API + 'changepassword', {Oldpassword,Newpassword,token}, httpOptions);
  }
...
//----------------schedule----------------//
updateschedule():Observable<any>{
  const token = this.storageService.getTokent();
  return this.http.post(INFO_API + 'updateschedule', {token}, httpOptions);
}
